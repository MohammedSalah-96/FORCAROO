...
import { ServiceTypesProps, NavbarLinksProps, WorkProcessDetailsProps } from "../types";
...
export const useLocalizedData = () => {
  ...
  const homeSliderTitles: string[] = t('homeSlider.homeSliderTitles', { returnObjects: true }) as string[]

  const homeSliderDescriptions: string[] = t('homeSlider.homeSliderDescriptions', { returnObjects: true }) as string[]
  ...
  const productsList = [
  {
    ...
    description: '100W Monocrystalline Solar Panel - High Efficiency for Off-Grid Systems',
    price: 89.00,
  ...
  },
  {
    ...
    description: '400W Monocrystalline Solar Panel - Premium Grade for Home Systems',
    price: 249.00,
    category: 'solar-panel',
    rating: 4.7,
  ...
  },
  {
    ...
    description: '5kWh Lithium Iron Phosphate (LiFePO4) Battery - Long Cycle Life',
    price: 950.00,
    category: 'battery',
    rating: 4.4,
  ...
  },
  {
    ...
    description: '2kWh Deep Cycle Gel Battery - Maintenance-Free Backup Power',
    price: 360.00,
    category: 'battery',
    rating: 4.2,
  ...
  },
  {
    ...
    description: '3kWh Deep Cycle Gel Battery - Maintenance-Free Backup Power',
    price: 260.00,
    category: 'battery',
    rating: 4.6,
  ...
  },
  {
    id: 9,
    name: 'SOLAR-KIT-1KW',
    description: '1kW Complete Solar Kit (Panels, Inverter, Mounting, Cables)',
    price: 999.00,
    category: 'kit',
    rating: 4.5,
  ...
  const kartalServices: ServiceTypesProps[] = [
    ...
    },
    {
      ...
      description: t('servicesCompany.services.solarPanelSolutions.description')
    },
    {
      id: 6,
      ...
      description: t('servicesCompany.services.solarInstallationServices.description')
    },
    {
      id: 7,
      ...
      description: t('servicesCompany.services.afterSalesSolarSupport.description')
    },
    {
      id: 8,
      ...
      description: t('servicesCompany.services.evChargingSolutions.description')
    },
    {
      id: 10,
      ...
      description: t('servicesCompany.services.solarBatteryRecycling.description')
    }
  ]
  ...
  return { navLinks, homeSliderTitles, homeSliderDescriptions,productsList, kartalServices, workProcessSteps, blogPosts }
}
